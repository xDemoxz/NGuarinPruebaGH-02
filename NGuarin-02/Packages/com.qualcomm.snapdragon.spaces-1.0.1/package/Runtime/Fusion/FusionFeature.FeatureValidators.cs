...
namespace Qualcomm.Snapdragon.Spaces
{
    internal partial class FusionFeature
    {
        ...
        private ValidationRule Required_Project_OpenXrPluginNot1_11()
        {
            return new ValidationRule(this)
            {
                message = "Project Requirement: Dual Render Fusion projects do not work with OpenXR Plugin version 1.11.0. When using this version of the plugin no content will be rendered on the Phone.",
                checkPredicate = () =>
                {
#if OPENXR_1_11_0
                    return false;
                ...
                fixIt = () =>
                {
                    ...
                    const string problemVersion = "1.11.0";
                    ...
                    foreach (var packageInfo in packageInfos)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (dependency.name == openXrPackageName && dependency.version == problemVersion)
                                {
                ...
                error = true,
                fixItMessage = "Display packages which rely on the OpenXR Plugin version 1.11.0, and opens the PackageManager to allow the developer to try and select a different version of the plugin.",
                fixItAutomatic = false
            };
        }
        ...
        protected override void GetValidationChecks(List<ValidationRule> rules, BuildTargetGroup targetGroup)
        {
            ...
            rules.Add(Required_Project_OpenXrPluginNot1_11());
        }
    }
}
#endif
